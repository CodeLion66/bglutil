...
func (k *ExtendedKey) Derive(i uint32) (*ExtendedKey, error) {
	...
	parentFP := bglutil.Hash160(k.pubKeyBytes())[:4]
...
func (k *ExtendedKey) Address(net *chaincfg.Params) (*bglutil.AddressPubKeyHash, error) {
	pkHash := bglutil.Hash160(k.pubKeyBytes())
	return bglutil.NewAddressPubKeyHash(pkHash, net)
}
