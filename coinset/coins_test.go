...
func NewCoin(index int64, value bglutil.Amount, numConfs int64) coinset.Coin {
	h := sha256.New()
...
var (
	...
	testSimpleCoinTxValue0            = bglutil.Amount(3500000)
	...
	testSimpleCoinTx, _               = bglutil.NewTxFromBytes(testSimpleCoinTxBytes)
